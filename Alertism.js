...
function Toast(text = "This is a Toast.", Tbackground, Tcolor)
{
	...
	var css = `
    #toast{visibility:hidden;text-align:center;border-radius:0;padding:16px;position:fixed;z-index:999999999999999999999999999;left:50%;transform:translateX(-50%);bottom:30px;font-size:1rem;font-weight:bold;color:#fff;background-color:#333;font-family:'Montserrat',sans-serif;transition:.5s}#toast.active{visibility:visible;animation:fadein .5s,fadeout .5s 1.5s}@keyframes fadein{from{bottom:0;opacity:0}to{bottom:30px;opacity:1}}@keyframes fadeout{from{bottom:30px;opacity:1}to{bottom:0;opacity:0}}@media(max-width:1201px){#toast{width:50%}}@media(max-width:991px){#toast{width:50%}}@media(max-width:661px){#toast{width:calc(100% - 30vw)}}@media(max-width:331px){#toast{width:calc(100% - 10vw)}}
    `,
		head = document.head || document.getElementsByTagName('head')[0],
		style = document.createElement('style');
	head.appendChild(style);
