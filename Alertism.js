...
div.innerHTML = `
<div id='alert-backdrop' class='alert-hide'><div id='alert-container'><div id='glassmorphism'></div><div id='icon-tick'></div><div id='icon-cross'></div><div id='icon-info'></div><h2 id='alert-h2'></h2><p id='alert-p'></p><input id='alert-input' type='text' autocomplete='off'><div id='btn-container'><button id='cancel-btn'></button><button id='ok-btn'></button></div></div></div>
`,
...
function Alertism(arguments, animation)
{
	...
	mainAlert.classList.remove("alert-hide");

	if (arguments.alertBackground !== undefined)
	{
		alertBox.style.backgroundColor = arguments.alertBackground;
	}
	else
	{
	...
	{
		alertOkBtn.innerText = arguments.btnText;
	}
	else
	{
	...
	{
		alertH2.innerText = arguments.title;
	}
	else
	{
		alertH2.innerText = "Alert";
	}

	if (arguments.text !== undefined)
	{
		alertP.innerText = arguments.text;
	}
	else
	{
		alertP.innerText = "This is an Alert Box.";
	}
