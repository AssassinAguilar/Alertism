...
div.setAttribute("id","superContainer");
...
const mainAlert = document.getElementById("alert-backdrop");

const alertOkBtn = document.getElementById("ok-btn");

const alertCloseBtn = document.getElementById("cancel-btn");

const alertInputValue = document.getElementById("alert-input").value;

const tickIcon = document.getElementById("icon-tick");

const crossIcon = document.getElementById("icon-cross");

const infoIcon = document.getElementById("icon-info");

const alertH2 = document.getElementById("alert-h2");

const alertInputPlace = document.getElementById("alert-input").placeholder;
