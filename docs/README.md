**_Note:- All the documentations ( docs ) are of latest version of Alertism ( V2.0.0 ). If you want to use Alertism V1 then see this link <a href="">Alertism V1 docs</a>_**
# Introduction
